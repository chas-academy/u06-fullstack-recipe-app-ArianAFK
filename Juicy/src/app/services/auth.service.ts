...
export class AuthService {
  ...
  postLogin(loginObj: Login) {
    ...
    return this.http.post<any>('https://u06-fullstack-recipe-app-arianafk.onrender.com/api/login', loginObj)
  }
  postRegister(registerObj: Register) {
    if (!registerObj) return
    console.log(registerObj);
    return this.http.post<any>('https://u06-fullstack-recipe-app-arianafk.onrender.com/api/register', registerObj)
  }
  postLogout(token: any) {
    ...
    console.log(headers);
    return this.http.post<any>('https://u06-fullstack-recipe-app-arianafk.onrender.com/api/logout', {}, {
      headers
    })
  }
}
